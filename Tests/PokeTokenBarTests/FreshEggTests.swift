...
final class FreshEggTests: XCTestCase {
    ...
    /// 활성 포켓몬(baseID 10, common 3형태, 성장 20M) + 도감 1개 + 수집기록 1개(1:3) + 지갑.
    ...
    private func store(active: Bool = true, shiny: Bool = false, used: Int = 5_000_000_000,
        ...
        let mon = "{\"baseID\":10,\"pathIDs\":[10],\"stageIndex\":0,\"usedAtStage\":20000000,"
    ...
    func testPriceIsHundredMillion() { XCTAssertEqual(FreshEgg.price, 100_000_000) }
