...
5. 🍬 **한도 쓰면서 사탕 받기.** 5시간 또는 주간 사용량 한도를 써 나가면서 40%·80%·100% 지점마다 **이상한 사탕**을 받아요 — 새 **가방** 탭에서 써서 현재 포켓몬을 키우세요.
...
<tr>
<td width="55%" valign="middle">
<h3>🍬 한도를 써 나가면 이상한 사탕</h3>
5시간 또는 주간 사용량 한도를 써 나가면서 40%·80%·100% 지점마다 <b>이상한 사탕</b>을 받습니다 — 5시간 한도당 3개, 주간 한도당 10개. 새 <b>가방</b> 탭에서 현재 포켓몬에게 써서 키우세요: 많이 쓸수록 꾸준히 자라고, 한도에 막혀도 보상이 가장 큽니다.
</td>
