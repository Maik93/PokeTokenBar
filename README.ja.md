...
5. 🍬 **上限を使ってごほうび。** 5時間または週間の使用量上限を使っていくと、40%・80%・100% のたびに **ふしぎなアメ** がもらえます — 新しい **バッグ** タブから使って、いまのポケモンを育てましょう。
...
<tr>
<td width="55%" valign="middle">
<h3>🍬 上限を使っていくと、ふしぎなアメ</h3>
5時間または週間の使用量上限を使っていくと、40%・80%・100% のたびに <b>ふしぎなアメ</b> がもらえます — 5時間上限で3個、週間上限で10個。新しい <b>バッグ</b> タブから使っていまのポケモンを育てましょう。たくさん使うほど着実に育ち、上限に達しても報酬が最大です。
</td>
